...
## 11 · Install CLI — `npx pds-stack install`
...
Welcome to PDS Stack V3.
The design-first workflow for Product Designers.

? What framework are you using?
  › Next.js · Nuxt · SvelteKit · Astro · Other

? Primary language?
  › TypeScript · JavaScript · Python · Other

? UI library?
  › Shadcn/ui · Radix · Tailwind only · None

? Brief depth for this project?
  › Quick Start (15 min) · Standard (45 min) · Full (90 min)
...
✓ Generating PROJECT_BRIEF (T1)...
✓ Done. Open agent-system/PROJECT_BRIEF_TEMPLATE.md to start.

Next step: fill the brief, then run /ray.
```

### What gets generated
- `STACK.md` — stack config
- `CLAUDE.md` — agent registry + hard constraints
- `agent-system/` — full directory with agents, templates, context files
- `.claude/commands/` — slash command files for each agent
...
| Install | Manual | `npx pds-stack install` |
