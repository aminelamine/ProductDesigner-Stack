---
description: BOB — Builder & UI/UX Engineer. Quality Brief (gate), implémente, commit.
mode: agent
---
...
registre d'agents et les hard constraints (VS Code le lit déjà nativement, mais confirme-le).
