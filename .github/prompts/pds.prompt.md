---
description: PDS Conductor — adaptive entry point. Asks the lane, then runs direction → scope → production → judgment.
mode: agent
---
...
- First output is an interactive HTML prototype (`/bob --proto`), in every lane. Standard and
  System continue to Figma. Product code runs only with `modules.code: true`.
