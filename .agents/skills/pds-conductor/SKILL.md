...
description: >
  ...
  connaître la séquence de commandes ni le rituel VALIDÉE TALENT. S'adapte au niveau de
...
pour le registre d'agents et les hard constraints — Codex ne lit nativement que `AGENTS.md`, pas
`CLAUDE.md`.
